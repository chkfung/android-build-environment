...
ENV ANDROID_COMPONENTS platform-tools,android-23,build-tools-23.0.2,build-tools-24.0.0,build-tools-25.0.2,extra-google-m2repository
...
ENV PATH $PATH:$ANDROID_NDK_HOME/build-tools/25.0.2
